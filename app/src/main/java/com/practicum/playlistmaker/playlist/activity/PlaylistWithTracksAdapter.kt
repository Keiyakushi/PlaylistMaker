...
class PlaylistWithTracksAdapter (private val clickListener: TrackClickListener,private val longTrackClickListener: LongTrackClickListener) :
    RecyclerView.Adapter<PlaylistWithTracksViewHolder>() {
    var trackAdapterList = ArrayList<Track>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = PlaylistWithTracksViewHolder(
